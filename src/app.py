...
app = FastAPI(
    ...
    description="Unified Enterprise Portal for Policy Agent, WorkWeek HCM Agent, and ServiceImmediately ITSM Agent with Corp SSO",
    version="3.0.0",
)
...
def get_itsm_agent(model_name: str = "auto") -> ServiceImmediatelyAgent:
    global _itsm_agent
    if _itsm_agent is None or (model_name != "auto" and _itsm_agent.model_name != model_name):
